                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold, text-gray-900 dark:text-white">Aplicacción de Notas</div>
                        </div>
                    ...
                    <div class="p-6">
                        <Link v-if="$page.props.user" :href="route('dashboard')" class="underline text-gray-900 dark:text-white">
                Dashboard
            </Link>
